...
meRouter.put('/me', requireAuth, asyncHandler(userController.updateProfile));
meRouter.patch('/me/password', requireAuth, asyncHandler(userController.changePassword));
